...
//*************************************************************************************************
//
// Модуль функционала для получения даты и номера версии
// 
//*************************************************************************************************
...
char *FWVersion( uint32_t version ) {
    ...
    if ( toupper( rc ) == 'T' || toupper( rc ) == 'D' || toupper( rc ) == 'P' || toupper( rc ) == 'R' )
...
//*************************************************************************************************
// Расшифровка версии CMSIS в текстовый буфер
//-------------------------------------------------------------------------------------------------
// uint32_t version - значение версии в формате: [31:16] CMSIS HAL main version
//                                               [15:00] CMSIS HAL sub version 
// char *str        - указатель на строку для размещения результата
// return           - указатель на строку с расшифровкой в формате main.sub1
//*************************************************************************************************
char *CSVersion( uint32_t version ) {
    ...
    main = version >> 16;
    sub1 = version & 0x000000FF;
    sprintf( val_ver, "%u.%u", main, sub1 );
    return val_ver; 
 }
